...
function HomePage() {
  return (
    <div className="min-h-screen text-white selection:bg-[#8bc34a] selection:text-black font-sans pb-24">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-4 text-gray-400 leading-relaxed">
              <p>
                ...
                of all backgrounds. Whether you are working on a personal zine, decorating your living space, or building
      ...
      {/* License Section */}
      <section id="license" className="max-w-7xl mx-auto px-6 mt-16 scroll-mt-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-sm text-gray-400">
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>Personal prints and posters</li>
      ...
      <footer className="max-w-7xl mx-auto px-6 mt-32 pt-16 pb-12 border-t border-[#222222]">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-gray-500 text-sm">
          <div className="flex flex-col gap-2 items-center md:items-start text-center md:text-left">
            <span className="font-display font-bold text-white tracking-widest text-xs uppercase">Open Source Art Project</span>
